...
namespace ProGaudi.Tarantool.Client
{
    public interface IBox : IDisposable
    {
        ...
        Task<DataResponse<TResponse[]>> ExecuteSql<TResponse>(string query, TimeSpan? timeout, params SqlParameter[] parameters);

        Task<DataResponse> ExecuteSql(string query, TimeSpan? timeout, params SqlParameter[] parameters);
    }
}